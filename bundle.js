...
/***/ function(module, exports, __webpack_require__) {
	...
	var logResponseBody = function logResponseBody(responseBody) {
	...
	var signUpUser = function signUpUser(e) {
	  e.preventDefault();
	...
	var signOutUser = function signOutUser(e) {
	  e.preventDefault();
	  $.ajax({
	...
	var getSuggestId = function getSuggestId(e) {};

	var vote = function vote(e) {};

	var displayEntries = function displayEntries(response) {
	  var entries = response.entries;
	  var entryListingTemplate = __webpack_require__(6);
	  // $('.my-entries').html('');
	  $('.my-entries').html(entryListingTemplate({ entries: entries }));
	};
	...
	var displaySuggestions = function displaySuggestions(response) {
	  var suggestions = response.suggestions;
	  // debugger;
	  // $('.suggestions').html('');
	  var suggestionListingTemplate = __webpack_require__(27);

	  $('.suggestions').html(suggestionListingTemplate({ suggestions: suggestions }));
	  getEntries();
	};
	...
	var postSuggestion = function postSuggestion(e) {
	  e.preventDefault();
	  var suggestion = new FormData(e.target);
	  $.ajax({
	    url: constant.holder.baseUrl + '/suggestions',
	    method: 'POST',
	    headers: {
	...
	var postEntries = function postEntries(e) {
	  e.preventDefault();
	  var entry = new FormData(e.target);
	  $.ajax({
	    url: constant.holder.baseUrl + '/entries',
	    method: 'POST',
	    headers: {
	...
	var getId = function getId(e) {
	  var id = $(e.target).attr('data-edit-id');
	  $('.edit-entry-submit').attr('data-edit-id', id);
	  var a = $('.edit-entry-submit').attr('data-edit-id');
	  console.log(a);
	};

	var editEntries = function editEntries(e) {
	  e.preventDefault();
	  var entry = new FormData(e.target);
	  $.ajax({
	...
	var deleteEntries = function deleteEntries(e) {
	  $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(26),depth0,{"name":"entry","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"container entry-holder\">\n  "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "              <p>Dish I ate: "
	    + container.escapeExpression(((helper = (helper = helpers.dish || (depth0 != null ? depth0.dish : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"dish","hash":{},"data":data}) : helper)))
	    + "</p>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "<div class=\"row\">\n    <div class=\"each-entry col-md-8\">\n      <div class='entries'>\n        <div class='media-body' data-rating='"
	    ...
	    + "'>\n          <h1>"
	    + alias4(((helper = (helper = helpers.restaurant || (depth0 != null ? depth0.restaurant : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"restaurant","hash":{},"data":data}) : helper)))
	    ...
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.dish : depth0),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n            <p>"
	    + alias4(((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"content","hash":{},"data":data}) : helper)))
	    + "</p>\n          </div>\n\n          <button type=\"button\" class=\"btn btn-info edit-entry suggest-bttn\" data-toggle=\"modal\" data-target=\"#edit-entry-modal\" data-edit-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">Edit</button>\n          <button type=\"button\" class=\"btn btn-danger delete-entry suggest-bttn\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">Delete</button>\n        </div>\n      </div>\n    </div>\n\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(28),depth0,{"name":"suggestion","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "\n  "
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.suggestions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n";
	},"usePartial":true,"useData":true});
